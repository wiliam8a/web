...
@section('content')
    ...
    <div class="container text-center">
        <div class="page-header">
            <h1><i class="fa fa-rocket"></i> HobbieGo - DASHBOARD</h1>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="panel">
                    <i class="glyphicon glyphicon-picture icon-home"></i>
                    <a href="{{ route('admin.slider.index') }}" class="btn btn-danger btn-block btn-home-admin">Slider</a>
                </div>
            </div>
